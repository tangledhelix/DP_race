...
./make_project.py
```
* [ ] Read the [project comments](https://www.pgdp.net/c/project.php?id=projectID64d791ed8f9b0#project-comments)
* [ ] Subscribe to the [forum topic](https://www.pgdp.net/phpBB3/viewtopic.php?t=79973) and read all posts
* [ ] Open `race-utf8.txt` in Guiguts
...
* [ ] Open `race.html` that was saved previously.
...
* [ ] `make sr`
* [ ] Go to [project page](https://www.pgdp.net/c/project.php?id=projectID64d791ed8f9b0), select SR time period, upload `race-sr.zip`
...
* [ ] Enter copyright clearance (get from DP [project page](https://www.pgdp.net/c/project.php?id=projectID64d791ed8f9b0))
